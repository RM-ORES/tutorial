...
public class StrMenú {
    ...
    private static void strej2() {
        /*
         * 2. Hacer un menú que permita al usuario conocer el uso de 5 métodos de la
         * clase StringBuilder. El programa debe dar la opción 6 para poder salir del
         * mismo.
         */
        Scanner input = new Scanner(System.in);
        int option;
    ...
    private static void bufferej4() {
        ...
        System.out.println("Reemplazando todo menos el primer y último caracter: "
                + cadena3.replace(1, cadena3.length() - 1, sust0));
    }
    ...
    private static void strej3() throws IOException {
        /*
         * 3.Repetir el ejercicio1 pidiendo datos al usuario mediante el uso de String,
    ...
    //DESDE ECLIPSE
    private static void method2ej1() throws IOException {
        BufferedReader buffinput = new BufferedReader(new InputStreamReader(System.in));
        System.out.println("Introduce una palabra");
        String palabra0 = buffinput.readLine();
        System.out.println("¿Qué índice quieres encontrar?");
        String num = buffinput.readLine();
        int indexchar = Integer.parseInt(num);
        System.out.println("El char en la posición " + indexchar + " es: " + palabra0.charAt(indexchar - 1));
    }

    private static void method2ej2() throws IOException {
        BufferedReader buffinput = new BufferedReader(new InputStreamReader(System.in));
        System.out.println("Introduce una palabra");
        String palabra1 = buffinput.readLine();
        System.out.println("¿Qué letra quieres encontrar?");
        String letra0 = buffinput.readLine();
        System.out.println("La posición de la letra '" + letra0 + "' es: " + (palabra1.indexOf(letra0) + 1));
    }

    private static void method2ej3() throws IOException {
        BufferedReader buffinput = new BufferedReader(new InputStreamReader(System.in));
        System.out.println("Introduce una palabra");
        String palabra2 = buffinput.readLine();
        System.out.println("¿Qué letra quieres reemplazar?");
        String entrada = buffinput.readLine();
        char letra1 = entrada.charAt(0);
        System.out.println(palabra2.replace(letra1, 'x'));
    }

    //DESDE INTELLIJ
    private static void method2ej4() throws IOException {
        BufferedReader buffinput = new BufferedReader(new InputStreamReader(System.in));
        System.out.println("Introduce una palabra");
        String palabra3 = buffinput.readLine();
        System.out.println("La palabra '" + palabra3 + "' tiene " + palabra3.length() + " caracteres.");
    }

    private static void method2ej5() throws IOException {
        BufferedReader buffinput = new BufferedReader(new InputStreamReader(System.in));
        System.out.println("Introduce una palabra");
        String palabra4 = buffinput.readLine();
        System.out.println("¿Qué quieres sumarle?");
        String palabra5 = buffinput.readLine();
        System.out.println("La suma de las dos cadenas es: " + palabra4.concat(palabra5));
    }

    private static void method2ej6() throws IOException {
        BufferedReader buffinput = new BufferedReader(new InputStreamReader(System.in));
        System.out.println("Introduce una palabra");
        String palabra6 = buffinput.readLine();
        System.out.println("Introduce la palabra a comparar");
        String palabra7 = buffinput.readLine();
        if (palabra6.equalsIgnoreCase(palabra7)) {
            System.out.println("Las palabras introducidas son iguales.");
        } else {
            System.out.println("Las palabras introducidas no son iguales.");
    ...
    private static void method2ej7() throws IOException {
        BufferedReader buffinput = new BufferedReader(new InputStreamReader(System.in));
        System.out.println("Introduce una palabra");
    ...
    private static void strej4() {
         ...
         * “palíndromo” o no lo es. Un palíndromo son aquellas palabras que se leen
         * igual de izquierda a derecha que de derecha a izquierda, por ejemplo ALLA.
         */
        Scanner input = new Scanner(System.in);
    ...
    private static void strej6() {
        /*
         * 6. Hacer un programa que: 1. Permita obtener la parte izquierda de una cadena
         * de caracteres, indicando el número de caracteres que se desean 2. Inicialice
         * la cadena de caracteres a una cadena texto por ejemplo “HOLA MUNDO” y
