...
//DESDE ECLIPSE
	private static void method2ej1() throws IOException {
		...
		String palabra0 = new String();
		String num = new String();
		System.out.println("Introduce una palabra");
		palabra0 = buffinput.readLine();
		System.out.println("¿Qué índice quieres encontrar?");
		num = buffinput.readLine();
	...
	private static void method2ej2() throws IOException {
		...
		String letra0 = new String();
		System.out.println("Introduce una palabra");
		palabra1 = buffinput.readLine();
		System.out.println("¿Qué letra quieres encontrar?");
		letra0 = buffinput.readLine();
		System.out.println("La posición de la letra '" + letra0 + "' es: " + (palabra1.indexOf(letra0) + 1));
	}
	...
	private static void method2ej3() throws IOException {
		...
		System.out.println("Introduce una palabra");
		palabra2 = buffinput.readLine();
		System.out.println("¿Qué letra quieres reemplazar?");
		entrada = buffinput.readLine();
